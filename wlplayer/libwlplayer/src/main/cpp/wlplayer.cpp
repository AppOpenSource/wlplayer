...
int main1() {
    ...
    char *m_connect_dvs_uid = "ss4";
    char *m_dispatch_server_strs = "139.9.52.144:8989";
    ...
    int n_ret = app_operation_h.Fut_ConnectDvsByP2PProtocol(0);
    if (n_ret == 1)
    {
        ...
        servaddr.sin_port = htons(app_operation_h.m_proxy_svr_port);
